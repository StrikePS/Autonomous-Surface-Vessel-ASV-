...
#include "asv_localization_interfaces/msg/detail/state_estimate__rosidl_typesupport_fastrtps_c.h"
...
using _StateEstimate__ros_msg_type = asv_localization_interfaces__msg__StateEstimate;
...
size_t get_serialized_size_asv_localization_interfaces__msg__StateEstimate(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _StateEstimate__ros_msg_type * ros_message = static_cast<const _StateEstimate__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _StateEstimate__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_asv_localization_interfaces__msg__StateEstimate(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_asv_localization_interfaces
size_t max_serialized_size_asv_localization_interfaces__msg__StateEstimate(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = asv_localization_interfaces__msg__StateEstimate;
    is_plain =
      (
...
static size_t _StateEstimate__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_asv_localization_interfaces__msg__StateEstimate(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, asv_localization_interfaces, msg, StateEstimate)() {
